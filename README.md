...
cp -r web3/evm-mint-watcher ~/.hermes/skills/web3/evm-mint-watcher/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/evm-mint-watcher-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/evm-mint-watcher-skill.git ~/.hermes/skills/web3/evm-mint-watcher/
```
...
```text
skill_view(name="web3/evm-mint-watcher")
```
...
```text
Use the evm mint watcher skill to <describe your specific task here>
```
...
```text
Gunakan skill evm mint watcher untuk <deskripsikan tugas spesifik Anda di sini>
```
